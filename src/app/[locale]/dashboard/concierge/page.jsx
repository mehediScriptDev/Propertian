  ...
  const [tickets, setTickets] = useState([
    {
      ...
      status: "Assigned",
      description:
        "Client wants to view 3 bedroom apartments in downtown area with modern amenities.",
      assignedTo: "Sarah Wilson",
      notes:
        "Client prefers morning appointments, has specific budget requirements.",
    },
    {
      id: 2,
      ...
      status: "In Review",
      description:
        "Looking for family home with garden space, 4+ bedrooms, near good schools.",
      assignedTo: null,
    ...
    },
    {
      ...
      status: "Scheduled",
      description:
        "First-time investor seeking advice on rental property investment opportunities.",
    ...
    },
    {
      ...
      status: "New",
      description:
        "Relocating from London, needs comprehensive area information and viewing assistance.",
      assignedTo: null,
    ...
    },
    {
      ...
      status: "Completed",
      description:
        "Viewed multiple properties, made decision on 2BR apartment with parking.",
      assignedTo: "Sarah Wilson",
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600">
              Overview of service requests, assignments and activity.
            </p>
          </div>
      ...
      <div className="grid gap-6 lg:grid-cols-1">
        ...
        <div className="lg:col-span-2 rounded-xl bg-white/50 shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="inline-flex items-center gap-2">
                        <button
                          ...
                          className="min-w-[110px] px-3 py-2 rounded-md text-sm font-medium text-[#E6B325] border border-[#E6B325] hover:bg-[#E6B325]/5"
                        >
                          View Details
                        </button>
          ...
          <div className="border-t border-gray-100 p-4 text-right">
            <Link
              href={`/${locale}/dashboard/concierge/tickets`}
              className="text-sm font-medium text-[#E6B325]"
            >
              View all tickets →
            </Link>
          </div>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <span
                      className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ml-2 ${getPriorityColor(
            ...
            <div className="flex flex-wrap gap-2 pt-4 border-t border-gray-200">
              ...
              {selectedTicket.status === "Assigned" && (
                <button
                  onClick={() =>
                    updateTicketStatus(selectedTicket.id, "Scheduled")
                  }
            ...
            <div className="flex gap-2 pt-4">
              ...
              <button
                onClick={() => setViewQuote(quotes[quotes.length - 1] || null)}
                className="min-w-[140px] px-3 py-2 rounded-md border border-gray-200 bg-white text-sm font-medium text-gray-700"
              >
                View Latest Quote
              </button>
            </div>
