...
//     // ✅ ALL HOOKS AT TOP - BEFORE isOpen CHECK
...
function CreateEventForm({ onCancel, onSuccess, formId = 'create-event-form', onSubmittingChange }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // ✅ Call success callback which will refresh data and close modal
            if (onSuccess) {
                console.log('✅ Event created! Calling onSuccess callback...');
                await onSuccess();
            } else {
