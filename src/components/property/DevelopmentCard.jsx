    ...
    <>
      ...
      >
        ...
        <div className="relative w-full aspect-video overflow-hidden">
          ...
          >
            {String(development.approvalStatus || development.raw?.approvalStatus || '').toUpperCase() === 'APPROVED' && (
              <div
                className="flex items-center gap-1.5 bg-red-600 text-white text-xs font-semibold px-2 py-1 rounded-full"
                role="status"
                aria-label="Approved listing"
              >
                <span>APPROVED</span>
              </div>
            )}
